...
'''class LoggedInUser(models.Model):
	LoggedInUserRollNumber = models.IntegerField()
	LoggedInUserFName = models.CharField(max_length = 45)
	LoggedInUserLName = models.CharField(max_length = 45)
	def __str__(self):
		return 'User: ' + self.LoggedInUserFName'''
